...
export type DamageHealthRow = {
  ...
  isTenSecondGoldDuration: boolean;
...
export const DAMAGE_HEALTH_BY_INGREDIENT = new Map<string, DamageHealthRow>([
  ...
  [
    "ectoplasm",
    { priority: 2, prePowerMag: 1 * 1, baseDurCk: 1, isTenSecondGoldDuration: false, goldMult: 1 },
  ],
  [
